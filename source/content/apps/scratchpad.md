...
Try the fully functional trial of the macOS app [here](https://www.dropbox.com/scl/fi/0v9zo9nyyji17wxzza1sk/Scratchpad-1.2.3-trial-1727723483.zip?rlkey=imv7fii2kw3ppdn4viegmb1as&raw=1). The only limitation is a reminder to buy the app every 12 hours, and no automatic updates. All data and settings carry over if you buy it on the App Store.
